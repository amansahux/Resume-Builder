...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const { jobRole, yearsOfExperience, techStack, experienceLevel } = body
        if (!jobRole || !techStack || !experienceLevel || !yearsOfExperience) return NextResponse.json<IResponse>({
            success: false,
